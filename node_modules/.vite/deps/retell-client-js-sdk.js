  ...
  return {
    ...
    writeMessage(message, options) {
      ...
      try {
        ...
        throw new Error(m + (r3.length > 0 ? ": ".concat(r3) : ""));
      }
      return json;
    },
...
var DataStream_FileHeader = proto3.makeMessageType("livekit.DataStream.FileHeader", () => [{
  no: 1,
  name: "file_name",
  kind: "scalar",
  T: 9
...
function r(r3, e2, n) {
  ...
  var a = null != (i = n.isImmediate) && i, u = null != (t = n.callback) && t, c2 = n.maxWait, v = Date.now(), l = [];
  function f() {
    if (void 0 !== c2) {
      var r4 = Date.now() - v;
...
function r2(t, e2) {
  return r2 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(t2, e3) {
...
var s = function(t) {
  ...
  l = t, (s2 = u).prototype = Object.create(l.prototype), s2.prototype.constructor = s2, r2(s2, l);
  var d = u.prototype;
  return d.startCall = function(t2) {
    ...
    this.room.on(RoomEvent.ParticipantDisconnected, function(e2) {
      "server" === (null == e2 ? void 0 : e2.identity) && t2.stopCall();
    }), this.room.on(RoomEvent.Disconnected, function() {
      t2.connected && t2.stopCall();
    });
  }, d.handleAudioEvents = function(t2) {
    var e2 = this;
    this.room.on(RoomEvent.TrackSubscribed, function(n, r3, c2) {
      n.kind === Track.Kind.Audio && ("agent_audio" === r3.trackName && n instanceof RemoteAudioTrack && t2.emitRawAudioSamples && (e2.analyzerComponent = createAudioAnalyser(n), e2.captureAudioFrame = window.requestAnimationFrame(function() {
    ...
    this.room.on(RoomEvent.DataReceived, function(e2, n, o2, i) {
      try {
        ...
        var a = c.decode(e2), r3 = JSON.parse(a);
        "update" === r3.event_type ? t2.emit("update", r3) : "metadata" === r3.event_type ? t2.emit("metadata", r3) : "agent_start_talking" === r3.event_type ? (t2.isAgentTalking = true, t2.emit("agent_start_talking")) : "agent_stop_talking" === r3.event_type ? (t2.isAgentTalking = false, t2.emit("agent_stop_talking")) : "node_transition" === r3.event_type && t2.emit("node_transition", r3);
      } catch (t3) {
